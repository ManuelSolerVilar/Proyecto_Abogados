...
namespace ProyectoAbogadosV2.Controllers
{
    public class ClientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Apellidos,NifCliente,MovilCliente,FijoCliente,FechaIngreso,FechaBaja,Email,Descripcion_Cliente,Direccion_Cliente,Poblacion_Cliente,Cp_Cliente")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
